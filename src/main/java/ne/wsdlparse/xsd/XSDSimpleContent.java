...
public class XSDSimpleContent extends XSDComplexElement<XSDElement<?>> {
    public XSDSimpleContent(WSDLManagerRetrieval manager, Node node) throws XPathExpressionException, SAXException, IOException, ParserConfigurationException, WSDLException {
